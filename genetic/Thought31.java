...
if(fo0 != null){
        ...
        Thought lo4 = Thought19.getInstance(fo1, fo0, fo1, fo0, fb1, lb1, lb2, fb0);
        Thought lo5 = Thought15.getInstance(fo1, fo0, fo1, fo0);
if(fo1 != null){
          fb1 = fo1.m2(fd0, fd1, ld3, fd0, lb1, lb2, fb0, fb1);
}
        lb1 = fd1 < ld3;
        lb2 = fd0 > fd1;
        ld3 *= -1;
...
if(fo1 != null){
    ...
    fb1 = !ab1;
    fd0 = fd1 + ld0;
    Thought lo1 = Thought20.getInstance(fo0, fo1, fo0, fo1, ab2, ab3, ab4, fb0);
    Thought lo2 = Thought53.getInstance(fo0, fo1, fo0, fo1);
    for(int i0=0; i0<10; i0++){
        fb1 = ab1 && ab2;
        }
    ab3 = !ab4;
...
if (false) { throw new CountDownExc(-1); }
    ...
    fb0 = fd0 < fd1;
    fb1 = ad1 > ad2;
    Thought lo0 = Thought56.getInstance(ad3, ad4, fd0, fd1, fb0, fb1, fb0, fb1);
if(fo1 != null){
      fo0 = fo1.m4();
}
    fb0 = !fb1;
...
if(fo0 != null){
    ...
    ad1 *= -1;
    Thought lo0 = Thought98.getInstance(fo1, fo0, fo1, fo0);
if(fo1 != null){
...
if(ao3 != null){
    ...
    Thought lo1 = Thought82.getInstance(ao2, ao3, ao4, fo0, fd0, fd1, ld0, fd0, fb1, fb0, fb1, fb0);
    double ld2 = 387.8634180016458;
    fd0 = fd1 + ld0;
    fb1 = !fb0;
    Thought lo3 = Thought89.getInstance(fo1, ao1, ao2, ao3, fb1, fb0, fb1, fb0);
    boolean lb4 = false;
if(ao4 != null){
    ...
    fb1 = lb4 || fb0;
if(ao3 != null){
      ao3.m1(fd1, ld0, ld2, fd0, fb1, lb4, fb0, fb1);
}
if(fo0 != null){
      ao4 = fo0.m4();
}
...
if(ao1 != null){
      fo1 = ao1.m4(ld2, ld5, fd0, fd1);
}
    ld0 = ld2 - ld5;
if(ao3 != null){
      ao2 = ao3.m4(fb0, fb1, lb4, fb0);
}
if(ao4 != null){
      fd0 = ao4.m3(fo0, fo1, ao1, ao2, fd1, ld0, ld2, ld5);
}
    fb1 = lb4 || fb0;
    for(int i0=0; i0<10; i0++){
        fb1 = lb4 && fb0;
if(ao4 != null){
          ao3 = ao4.m4(fo0, fo1, ao1, ao2, fd0, fd1, ld0, ld2, fb1, lb4, fb0, fb1);
}
}
Thought.STACK_COUNTER++;
} catch (StackOverflowExc | NoClassDefFoundError e) { 
...
if(ao1 != null){
    ...
    Thought lo1 = Thought76.getInstance(fd0, fd1, ad1, ad2, fb0, fb1, lb0, fb0);
    ad3 *= -1;
    fb1 = ad4 > fd0;
...
if(fo1 != null){
    ...
    lb0 = ad4 < fd0;
    Thought lo3 = Thought98.getInstance(fb0, fb1, lb0, fb0);
    fd1 *= -1;
if(ao2 != null){
...
if(fo0 != null){
    ...
    fd0 = fd1 + fd0;
    Thought lo2 = Thought62.getInstance(fd1, fd0, fd1, fd0, ab3, ab4, fb0, fb1);
    boolean lb3 = false;
...
if(fo1 != null){
    ...
    Thought lo1 = Thought43.getInstance(fo0, fo1, fo0, fo1, ad2, ad3, ad4, fd0);
if(fo0 != null){
...
if(fo0 != null){
    ...
    Thought lo2 = Thought45.getInstance(fd0, fd1, ad1, ad2, fb1, fb0, fb1, fb0);
    fb1 = !fb0;
    boolean lb3 = false;
    ad3 = ad4 + fd0;
...
if(fo0 != null){
      lb3 = fo0.m2(fo1, fo0, fo1, fo0, ld4, ad1, ad2, ad3, fb0, fb1, lb3, fb0);
}
    Thought lo5 = Thought35.getInstance(fo1, fo0, fo1, fo0, fb1, lb3, fb0, fb1);
if(fo1 != null){
...
if (false) { throw new CountDownExc(-1); }
    ...
    fd0 = fd1 + ld0;
if(fo0 != null){
          ad1 = fo0.m3(ad2, ad3, ad4, fd0, lb1, ab1, ab2, ab3);
}
    fd1 = ld0 + ad1;
...
if(ao1 != null){
    ...
    fd1 *= -1;
    Thought lo0 = Thought12.getInstance(fo1, ao1, ao2, ao3, fd0, fd1, fd0, fd1, fb0, fb1, fb0, fb1);
    fb0 = fd0 < fd1;
    fb1 = fb0 && fb1;
    boolean lb1 = false;
    fd0 = fd1 + fd0;
...
if(fo0 != null){
    ...
    fb0 = fd1 > ad1;
if(fo1 != null){
      fb1 = fo1.m2(ao1, ao2, ao3, ao4, ad2, ad3, ad4, fd0);
}
if(fo0 != null){
...
if(fo1 != null){
    ...
    boolean lb3 = true;
if(ao2 != null){
      ao1 = ao2.m4(lb2, lb3, ab1, ab2);
}
    Thought lo4 = Thought0.getInstance(ao3, ao4, fo0, fo1, fd1, fd0, fd1, fd0);
    ab3 = fd1 < fd0;
if(ao1 != null){
      ab4 = ao1.m2(ao2, ao3, ao4, fo0, fd1, fd0, fd1, fd0, fb0, fb1, lb0, lb1);
}
    fd1 = fd0 - fd1;
    boolean lb5 = true;
    lb2 = !lb3;
...
if(ao1 != null){
          ao1.m2(ad4, fd0, fd1, ld1, lb0, ab1, ab2, ab3);
}
        ab4 = fb0 && fb1;
        lb0 = ad1 < ad2;
        ad3 = ad4 - fd0;
...
if(fo0 != null){
        ...
        boolean lb3 = false;
        Thought lo4 = Thought44.getInstance(fo1, ao1, ao2, ao3, ad2, ad3, ad4, fd0);
if(ao4 != null){
          fd1 = ao4.m3(fo0, fo1, ao1, ao2, ld2, ad1, ad2, ad3, lb3, ab1, ab2, ab3);
}
}
Thought.STACK_COUNTER++;
return fb0;
...
if(fo0 != null){
    ...
    Thought lo1 = Thought93.getInstance(ld0, fd0, fd1, ld0, fb1, fb0, fb1, fb0);
if(fo0 != null){
      fo1 = fo0.m4();
}
if(fo1 != null){
...
if(fo1 != null){
    ...
    ab4 = fd0 > fd1;
    Thought lo1 = Thought76.getInstance(fo0, fo1, fo0, fo1, fb0, fb1, lb0, ab1);
if(fo1 != null){
      fo0 = fo1.m4(fo0, fo1, fo0, fo1);
}
if(fo1 != null){
...
if(fo0 != null){
    ...
    for(int i0=0; i0<10; i0++){
        Thought lo2 = Thought64.getInstance(fd1, fd0, fd1, fd0);
if(fo1 != null){
...
if (false) { throw new CountDownExc(-1); }
    ...
    fd0 = fd1 - ad1;
    ad2 = ad3 + ad4;
    Thought lo0 = Thought43.getInstance(fo0, fo1, fo0, fo1, fd0, fd1, ad1, ad2, fb0, fb1, fb0, fb1);
    fb0 = ad3 > ad4;
if(fo1 != null){
      fo0 = fo1.m4(fo0, fo1, fo0, fo1, fb1, fb0, fb1, fb0);
}
if(fo1 != null){
    ...
    boolean lb1 = false;
if(fo0 != null){
      fb0 = fo0.m2(fd0, fd1, ad1, ad2, fb1, lb1, fb0, fb1);
}
if(fo0 != null){
      fo1 = fo0.m4();
}
...
if(fo0 != null){
      fo0.m2(fo1, fo0, fo1, fo0, ld4, ad1, ad2, ad3);
}
if(fo0 != null){
      fo1 = fo0.m4(fo1, fo0, fo1, fo0, ad4, fd0, fd1, ld4, lb1, lb2, lb3, fb0);
}
if(fo1 != null){
...
if(fo1 != null){
    ...
    ad2 *= -1;
if(fo0 != null){
      ad3 = fo0.m3(ad4, fd0, fd1, ld4, fb0, fb1, lb1, lb2);
}
if(fo1 != null){
      fo1.m1();
}
...
if(ao3 != null){
    ...
    fb1 = ad4 < fd0;
if(ao4 != null){
      ao4.m1(fo0, fo1, ao1, ao2, fd1, ld0, ld1, ad1);
}
if(ao4 != null){
...
if(fo1 != null){
    ...
    ad4 = fd0 - fd1;
if(fo0 != null){
      ab3 = fo0.m2(ld0, ld1, ad1, ad2, ab4, fb0, fb1, ab1);
}
    ab2 = ab3 && ab4;
if(fo1 != null){
      fo1.m1();
...
if(fo1 != null){
    ...
    Thought lo0 = Thought45.getInstance(fd0, fd1, fd0, fd1);
...
if(fo1 != null){
    ...
    Thought lo0 = Thought99.getInstance(fo0, fo1, fo0, fo1, ab3, ab4, fb0, fb1);
    fd0 = fd1 + fd0;
if(fo1 != null){
      fo0 = fo1.m4(fo0, fo1, fo0, fo1);
}
...
if(fo0 != null){
    ...
    if (lb0) {
        lb2 = fb0 && fb1;
        Thought lo3 = Thought75.getInstance(fo1, fo0, fo1, fo0, ld1, ad1, ad2, ad3, lb0, lb2, fb0, fb1);
}
Thought.STACK_COUNTER++;
return fo1;
} catch (StackOverflowExc | NoClassDefFoundError e) { throw new CountDownExc(50);
...
if(ao1 != null){
      ld0 = ao1.m3(ad1, ad2, ad3, ad4, fb0, fb1, fb0, fb1);
}
    fd0 = fd1 + ld0;
if(ao2 != null){
      fb0 = ao2.m2();
...
if(fo0 != null){
    ...
    ad4 *= -1;
if(fo1 != null){
      fo1.m2(ao1, ao2, ao3, ao4, fd0, fd1, ld0, ad1);
}
if(fo1 != null){
...
if(fo1 != null){
        ...
        fb0 = fd0 < fd1;
        fb1 = !ab1;
        Thought lo0 = Thought39.getInstance(ao1, ao2, ao3, ao4, fd0, fd1, fd0, fd1);
...
if(ao3 != null){
    ...
    ld0 *= -1;
    Thought lo1 = Thought20.getInstance(ad1, ad2, ad3, ad4, ab2, ab3, ab4, fb0);
...
if (false) { throw new CountDownExc(-1); }
    ...
    fb0 = ld1 < fd0;
if(fo1 != null){
      fo0 = fo1.m4(fo0, fo1, fo0, fo1, fd1, ld0, ld1, fd0, fb1, lb2, fb0, fb1);
}
    fd1 = ld0 + ld1;
    lb2 = fd0 < fd1;
    ld0 = ld1 + fd0;
...
if(fo1 != null){
    ...
    fb0 = !fb1;
if(fo1 != null){
      fo0 = fo1.m4(fd1, ld0, ld1, fd0, lb2, lb3, fb0, fb1);
}
    boolean lb4 = true;
    fd1 = ld0 - ld1;
    lb2 = lb3 || lb4;
...
if(fo0 != null){
    ...
    Thought lo2 = Thought10.getInstance(lb1, fb0, fb1, lb0);
    double ld3 = 435.4467675366032;
    lb1 = fb0 && fb1;
if(fo1 != null){
      fo1.m1(fo0, fo1, fo0, fo1, ld3, fd0, fd1, ld3);
}
    fd0 *= -1;
    fd1 = ld3 - fd0;
    ...
    fb0 = fb1 || lb0;
if(fo0 != null){
      lb1 = fo0.m2(fo1, fo0, fo1, fo0, fd0, fd1, ld3, ld4, fb0, fb1, lb0, lb1);
}
    Thought lo5 = Thought34.getInstance(fo1, fo0, fo1, fo0, fb0, fb1, lb0, lb1);
    fb0 = fd0 < fd1;
if(fo1 != null){
      ld3 = fo1.m3(fo0, fo1, fo0, fo1);
}
if(fo1 != null){
      fo0 = fo1.m4(ld4, fd0, fd1, ld3, fb1, lb0, lb1, fb0);
}
if(fo1 != null){
      fo0 = fo1.m4();
}
...
if(fo1 != null){
    ...
    fb1 = lb0 || fb0;
    fb1 = lb0 || fb0;
    Thought lo2 = Thought61.getInstance(fo0, fo1, fo0, fo1, fd0, fd1, ld1, fd0);
    Output.points[7][7] -= fd1;
    ld1 = fd0 + fd1;
    Thought lo3 = Thought36.getInstance(fo0, fo1, fo0, fo1, ld1, fd0, fd1, ld1, fb1, lb0, fb0, fb1);
    lb0 = fd0 > fd1;
...
if(fo1 != null){
      fo0 = fo1.m4(fd0, fd1, ld1, ld4, fb0, fb1, lb0, fb0);
}
