...
private double fd0 = 644.2456448320544;
private double fd1 = 896.5311476470736;
...
if(fo1 != null){
    ...
    fd0 = fd1 - fd0;
    boolean lb2 = true;
    double ld3 = 240.73545452471168;
    double ld4 = 968.6173659611347;
    ld4 = fd0 - fd1;
    lb2 = ld3 > ld4;
    if (fb0) {
        boolean lb5 = false;
...
try {
if (false) { throw new CountDownExc(-1); }
    double ld0 = 539.1482330622516;
    ab2 = ab3 && ab4;
if(fo0 != null){
      fb0 = fo0.m2(ld0, fd0, fd1, ld0, fb1, ab1, ab2, ab3);
}
    ab4 = !fb0;
    fb1 = fd0 > fd1;
    ab1 = ld0 < fd0;
...
if(fo1 != null){
    ...
    ab4 = ld0 < fd0;
if(fo0 != null){
      fb0 = fo0.m2(fo1, fo0, fo1, fo0, fd1, ld0, fd0, fd1, fb1, lb1, ab1, ab2);
}
if(fo0 != null){
...
if(fo1 != null){
    ...
    Thought lo2 = Thought7.getInstance(fo0, fo1, fo0, fo1, fd1, ld0, fd0, fd1);
    ab2 = ab3 || ab4;
if(fo1 != null){
...
if(fo1 != null){
    ...
    double ld0 = 271.8607739027784;
    fb1 = fd0 < fd1;
    ld0 = ad1 - ad2;
    double ld1 = 507.2422345969507;
    boolean lb2 = false;
    ad2 = ad3 + ad4;
if(fo0 != null){
      lb2 = fo0.m2(fo1, fo0, fo1, fo0, fd0, fd1, ld0, ld1, fb0, fb1, lb2, fb0);
}
    boolean lb3 = false;
    fb0 = fb1 && lb2;
if(fo1 != null){
      fo1.m2(fo0, fo1, fo0, fo1, lb3, fb0, fb1, lb2);
}
    lb3 = ad1 < ad2;
if(fo1 != null){
...
if (false) { throw new CountDownExc(-1); }
    ...
    fb1 = !ab1;
    ad1 = ad2 - ad3;
    double ld1 = 865.5716303512006;
    double ld2 = 172.45132111086565;
    ab2 = !ab3;
    ...
    fb1 = ab1 && ab2;
if(fo0 != null){
      ab3 = fo0.m2(fd1, ld1, ld2, ad1, ab4, fb0, fb1, ab1);
}
...
if(ao2 != null){
    ...
    Thought lo0 = Thought10.getInstance(ao1, ao2, ao3, ao4, fd0, fd1, fd0, fd1, fb0, fb1, fb0, fb1);
    fd0 *= -1;
if(fo0 != null){
...
if(fo0 != null){
    ...
    Thought lo1 = Thought59.getInstance(fd0, fd1, fd0, fd1);
    fb1 = lb0 || fb0;
    fd0 *= -1;
if(fo0 != null){
      fo1 = fo0.m4(fo1, fo0, fo1, fo0, fd1, fd0, fd1, fd0);
}
    Thought lo2 = Thought20.getInstance(fb1, lb0, fb0, fb1);
    Thought lo3 = Thought64.getInstance();
    fd1 *= -1;
    fd0 *= -1;
    Thought lo4 = Thought57.getInstance(fd1, fd0, fd1, fd0, lb0, fb0, fb1, lb0);
if(fo0 != null){
...
if(fo1 != null){
    ...
    boolean lb1 = false;
    Thought lo2 = Thought82.getInstance(fd1, fd0, fd1, fd0, lb1, ab1, ab2, ab3);
    ab4 = fb0 || fb1;
    lb0 = lb1 || ab1;
if(fo1 != null){
...
if (false) { throw new CountDownExc(-1); }
    ...
    boolean lb1 = false;
    boolean lb2 = true;
    double ld3 = 493.01658097157394;
    double ld4 = 792.5629418831402;
if(fo0 != null){
          fo0.m3(ad1, ad2, ad3, ad4);
}
    Thought lo5 = Thought89.getInstance(fo1, fo0, fo1, fo0, fd0, fd1, ld3, ld4);
    ad1 *= -1;
...
if(fo1 != null){
    ...
    lb0 = fd1 > fd0;
    Thought lo1 = Thought91.getInstance(fo0, fo1, ao1, ao2, fd1, fd0, fd1, fd0, fb0, fb1, lb0, fb0);
    fd1 = fd0 + fd1;
if(ao3 != null){
...
if (false) { throw new CountDownExc(-1); }
    ...
    if (fb0) {
        ad2 = ad3 - ad4;
if(ao1 != null){
          fb1 = ao1.m2(fd0, fd1, ad1, ad2, lb0, fb0, fb1, lb0);
}
        ad3 *= -1;
...
if(ao3 != null){
        ...
        boolean lb1 = true;
        Thought lo2 = Thought58.getInstance(ao2, ao3, ao4, fo0, fb0, fb1, lb1, lb0);
        double ld3 = 607.5597916837451;
        fb0 = !fb1;
if(fo1 != null){
...
if(ao4 != null){
    ...
    fd0 = fd1 - fd0;
    double ld1 = 906.9267214028981;
    boolean lb2 = false;
if(ao3 != null){
      fb0 = ao3.m2(fb1, lb0, lb2, ab1);
}
    ab2 = !ab3;
    ab4 = fd0 < fd1;
    boolean lb3 = true;
...
if(ao2 != null){
        ...
        Thought lo5 = Thought23.getInstance(ao1, ao2, ao3, ao4, fd0, fd1, ld1, fd0, lb3, lb4, ab1, ab2);
        } else if (ab3) {
}
Thought.STACK_COUNTER++;
return ab4;
...
if(ao4 != null){
          ao4.m3(fd1, ld0, ad1, ad2, fb0, fb1, ab1, ab2);
}
        ab3 = ab4 && fb0;
...
if(fo1 != null){
    ...
    lb3 = !lb4;
    boolean lb5 = true;
    Thought lo6 = Thought87.getInstance();
if(fo0 != null){
          fo0.m1(fd1, ld2, fd0, fd1, lb5, fb0, fb1, lb0);
}
    ld2 = fd0 - fd1;
if(fo1 != null){
      fo1.m1(fo0, fo1, fo0, fo1);
}
    Thought lo7 = Thought52.getInstance(fo0, fo1, fo0, fo1, ld2, fd0, fd1, ld2, lb1, lb3, lb4, lb5);
    fd0 *= -1;
    fb0 = fd1 > ld2;
...
if (false) { throw new CountDownExc(-1); }
    boolean lb0 = true;
if(fo0 != null){
      fd0 = fo0.m3(fo1, fo0, fo1, fo0, lb0, ab1, ab2, ab3);
}
    fd1 *= -1;
    boolean lb1 = true;
    ab3 = !ab4;
...
if(fo0 != null){
    ...
    fd0 *= -1;
    ab4 = fd1 < fd0;
    double ld5 = 400.83011932325064;
    double ld6 = 234.45987760021876;
if(fo1 != null){
      fb0 = fo1.m2(ld6, fd0, fd1, ld5, fb1, lb0, lb1, lb2);
}
...
try {
if (false) { throw new CountDownExc(-1); }
    double ld0 = 871.1896079858499;
    ld0 = ad1 + ad2;
    Thought lo1 = Thought43.getInstance(fo0, fo1, fo0, fo1);
    fb1 = !fb0;
    fb1 = fb0 && fb1;
    ad3 = ad4 - fd0;
    Thought lo2 = Thought61.getInstance(fo0, fo1, fo0, fo1, fd1, ld0, ad1, ad2, fb0, fb1, fb0, fb1);
if(fo0 != null){
...
if(fo0 != null){
      lb3 = fo0.m2(fo1, fo0, fo1, fo0, ld0, ad1, ad2, ad3);
}
    fb0 = ad4 > fd0;
    boolean lb4 = true;
...
if(fo0 != null){
    ...
    Thought lo2 = Thought80.getInstance(fo1, fo0, fo1, fo0, ab2, ab3, ab4, fb0);
if(fo0 != null){
...
if(fo0 != null){
    ...
    double ld4 = 119.8501308755663;
if(fo1 != null){
      ld4 = fo1.m3(ad1, ad2, ad3, ad4, lb1, ab1, ab2, ab3);
}
    ab4 = fd0 < fd1;
    fb0 = ld4 < ad1;
    ad2 = ad3 - ad4;
...
if(fo1 != null){
    ...
    fb0 = fd0 > fd1;
    fd0 = fd1 - fd0;
    double ld1 = 989.613248015731;
if(fo0 != null){
      fd0 = fo0.m3(fo1, ao1, ao2, ao3, fd1, ld1, fd0, fd1, fb1, lb0, fb0, fb1);
}
if(ao4 != null){
...
if(ao1 != null){
    ...
    boolean lb1 = true;
    Thought lo2 = Thought30.getInstance(lb0, lb1, fb0, fb1);
    lb0 = lb1 || fb0;
    fb1 = !lb0;
    lb1 = fb0 && fb1;
    lb0 = !lb1;
    double ld3 = 962.8968370154516;
    if (fb0) {
if(ao1 != null){
          fo1 = ao1.m4();
}
        ...
        lb1 = fb0 || fb1;
if(ao2 != null){
          ao2.m2(ad2, ad3, ad4, fd0, lb0, lb1, fb0, fb1);
}
if(ao3 != null){
          ao3.m2(ao4, fo0, fo1, ao1);
}
if(ao2 != null){
          lb0 = ao2.m2(ao3, ao4, fo0, fo1, fd1, ld3, ad1, ad2, lb1, fb0, fb1, lb0);
}
if(ao2 != null){
...
if(ao1 != null){
        ...
        double ld4 = 163.13295273613852;
        Thought lo5 = Thought65.getInstance(ao2, ao3, ao4, fo0, ld4, ld3, ad1, ad2);
}
Thought.STACK_COUNTER++;
return ad4;
} catch (StackOverflowExc | NoClassDefFoundError e) { throw new CountDownExc(50);
...
if(fo1 != null){
      fo1.m3(ao1, ao2, ao3, ao4, fd1, fd0, fd1, fd0, ab4, fb0, fb1, ab1);
}
    fd1 = fd0 - fd1;
if(fo0 != null){
    ...
    if (ab1) {
        double ld0 = 811.543694871832;
if(ao4 != null){
          ao4.m1(ld0, fd0, fd1, ld0);
}
if(fo0 != null){
...
if(fo0 != null){
    ...
    fb0 = fd1 < ld2;
if(fo1 != null){
      fb1 = fo1.m2(fd0, fd1, ld2, fd0, lb0, lb1, lb3, fb0);
}
...
if(fo1 != null){
    ...
    double ld0 = 346.2041309643445;
if(fo0 != null){
      fd0 = fo0.m3(fo1, fo0, fo1, fo0, fd1, ld0, fd0, fd1, ab4, fb0, fb1, ab1);
}
    ld0 *= -1;
    fd0 = fd1 - ld0;
    Thought lo1 = Thought47.getInstance(fo1, fo0, fo1, fo0, ab2, ab3, ab4, fb0);
    Thought lo2 = Thought24.getInstance(fd0, fd1, ld0, fd0);
    fd1 *= -1;
        ld0 *= -1;
if(fo1 != null){
...
if(fo1 != null){
    ...
    boolean lb5 = false;
if(fo0 != null){
      ab3 = fo0.m2(fo1, fo0, fo1, fo0, fd0, fd1, ld0, fd0, ab4, fb0, fb1, lb4);
}
if(fo0 != null){
      fo1 = fo0.m4(fo1, fo0, fo1, fo0, lb5, ab1, ab2, ab3);
}
    ab4 = fb0 || fb1;
if(fo1 != null){
...
if(fo0 != null){
    ...
    lb1 = lb2 || fb0;
    fb1 = fd1 < ad1;
    double ld3 = 715.63571341362;
    Thought lo4 = Thought96.getInstance(fo1, fo0, fo1, fo0, lb0, lb1, lb2, fb0);
if(fo0 != null){
      fo1 = fo0.m4(ad1, ad2, ad3, ad4);
}
    double ld5 = 464.90220704461143;
if(fo1 != null){
          ad4 = fo1.m3(fo0, fo1, fo0, fo1, fd0, fd1, ld3, ld5);
}
    fb1 = !lb0;
    lb1 = lb2 || fb0;
...
if(fo1 != null){
    ...
    ab4 = fb0 && fb1;
if(fo1 != null){
      fo0 = fo1.m4(fo0, fo1, fo0, fo1, ad4, fd0, fd1, ad1, lb1, ab1, ab2, ab3);
}
    ab4 = fb0 || fb1;
    boolean lb2 = false;
    if (lb1) {
if(fo1 != null){
        ...
        ab4 = ad2 > ad3;
        fb0 = !fb1;
        double ld3 = 435.2513268783843;
        lb1 = !lb2;
        double ld4 = 925.7795535635;
        ad2 = ad3 + ad4;
if(fo0 != null){
          ab1 = fo0.m2(fd0, fd1, ld3, ld4);
}
        boolean lb5 = true;
if(fo1 != null){
          ad1 = fo1.m3(fo0, fo1, fo0, fo1, ad2, ad3, ad4, fd0);
}
        Thought lo6 = Thought58.getInstance(ab1, ab2, ab3, ab4);
if(fo1 != null){
          fo0 = fo1.m4();
}
}
...
if(ao4 != null){
            ...
            lb1 = !lb0;
            fb0 = fb1 || lb1;
            Thought lo2 = Thought83.getInstance(lb0, fb0, fb1, lb1);
            double ld3 = 640.179529247802;
            lb0 = ld3 > fd0;
            fb0 = fd1 > ld3;
}}
Thought.STACK_COUNTER++;
...
if(ao3 != null){
      ao3.m1(ao4, fo0, fo1, ao1, ad1, ad2, ad3, ad4, fb1, fb0, fb1, fb0);
}
if(ao3 != null){
      ao2 = ao3.m4(ao4, fo0, fo1, ao1, fb1, fb0, fb1, fb0);
}
    Output.points[7][7] -= fd0;
    Thought lo0 = Thought98.getInstance(fd1, ad1, ad2, ad3);
    double ld1 = 964.014891572008;
if(ao3 != null){
...
if(fo0 != null){
      ao4 = fo0.m4(ad3, ad4, fd0, fd1, fb0, fb1, lb2, lb3);
}
if(fo1 != null){
...
try {
if (false) { throw new CountDownExc(-1); }
    double ld0 = 961.353736649194;
    ab1 = ab2 && ab3;
    ab4 = fd0 < fd1;
    boolean lb1 = false;
    double ld2 = 30.217916323156988;
    ab4 = fb0 && fb1;
if(ao2 != null){
      ao2.m3(ao3, ao4, fo0, fo1, ld0, ld2, fd0, fd1, lb1, ab1, ab2, ab3);
}
    Thought lo3 = Thought33.getInstance(ao1, ao2, ao3, ao4, ab4, fb0, fb1, lb1);
if(fo0 != null){
      fo0.m1(ld0, ld2, fd0, fd1);
}
    double ld4 = 458.74682324612894;
        ab1 = ld0 > ld2;
    ld4 *= -1;
...
try {
if (false) { throw new CountDownExc(-1); }
    Thought lo0 = Thought49.getInstance(ao1, ao2, ao3, ao4, ad1, ad2, ad3, ad4);
if(fo1 != null){
...
if(ao2 != null){
    ...
    ab2 = fd0 > fd1;
if(ao3 != null){
      ao3.m3(ad1, ad2, ad3, ad4, ab3, ab4, fb0, fb1);
}
    double ld1 = 426.9669341945179;
    ab1 = ad4 < fd0;
if(fo0 != null){
      ao4 = fo0.m4(fo1, ao1, ao2, ao3);
}
if(ao4 != null){
      fd1 = ao4.m3(fo0, fo1, ao1, ao2, ld1, ad1, ad2, ad3, ab2, ab3, ab4, fb0);
}
...
if (false) { throw new CountDownExc(-1); }
    fb1 = fd0 > fd1;
    Thought lo0 = Thought14.getInstance(fo1, fo0, fo1, fo0, fb0, fb1, fb0, fb1);
if(fo0 != null){
      fo1 = fo0.m4(fd0, fd1, fd0, fd1);
}
if(fo0 != null){
...
if(fo0 != null){
    ...
    Thought lo1 = Thought52.getInstance(fd0, fd1, fd0, fd1, fb0, fb1, fb0, fb1);
if(fo0 != null){
      fo1 = fo0.m4(fo1, fo0, fo1, fo0);
}
if(fo1 != null){
...
try {
if (false) { throw new CountDownExc(-1); }
    Thought lo0 = Thought48.getInstance(fo0, fo1, fo0, fo1, fb1, fb0, fb1, fb0);
    fb1 = fd0 < fd1;
if(fo0 != null){
...
if(fo1 != null){
    ...
    double ld1 = 98.05925057248022;
    ld1 *= -1;
    Thought lo2 = Thought66.getInstance(fo0, fo1, fo0, fo1, fd0, fd1, ld1, fd0, fb1, fb0, fb1, fb0);
if(fo1 != null){
      fo0 = fo1.m4(fo0, fo1, fo0, fo1, fb1, fb0, fb1, fb0);
}
...
if(fo0 != null){
    ...
    Thought lo3 = Thought95.getInstance(fo1, fo0, fo1, fo0, fd1, ld1, fd0, fd1);
    fb0 = ld1 < fd0;
if(fo1 != null){
