...
if(fo1 != null){
    ...
    fd0 *= -1;
    Thought lo3 = Thought14.getInstance(fd1, ld2, fd0, fd1, fb0, fb1, lb0, lb1);
    fb0 = fb1 || lb0;
    lb1 = fb0 || fb1;
    ld2 = fd0 - fd1;
if(fo1 != null){
...
if(fo0 != null){
          ld5 = fo0.m3(fo1, fo0, fo1, fo0, fd0, fd1, ld2, ld5, lb0, lb1, lb4, fb0);
}
...
try {
if (false) { throw new CountDownExc(-1); }
    Thought lo0 = Thought22.getInstance(fo1, fo0, fo1, fo0, ab1, ab2, ab3, ab4);
    Thought lo1 = Thought20.getInstance(fd0, fd1, fd0, fd1);
if(fo0 != null){
...
if(ao2 != null){
    ...
    fb0 = fb1 || fb0;
    fd1 = fd0 + fd1;
    Thought lo0 = Thought81.getInstance(ao3, ao4, fo0, fo1);
    fb1 = fd0 < fd1;
if(ao2 != null){
...
if(ao2 != null){
    ...
    fb1 = lb1 && fb0;
    boolean lb2 = false;
    Thought lo3 = Thought85.getInstance(fb0, fb1, lb1, lb2);
    ad1 = ad2 - ad3;
if(ao1 != null){
      fb0 = ao1.m2();
}
...
if(ao2 != null){
    ...
    Thought lo0 = Thought50.getInstance(ao3, ao4, fo0, fo1);
if(ao2 != null){
...
if(ao1 != null){
    ...
    Thought lo4 = Thought59.getInstance(ao2, ao3, ao4, fo0, ld1, fd0, fd1, ld1);
if(fo1 != null){
...
if(ao1 != null){
    ...
    ab2 = ab3 && ab4;
    Thought lo5 = Thought64.getInstance(fd0, fd1, ld1, fd0, fb0, fb1, lb2, lb3);
    ab1 = !ab2;
    boolean lb6 = false;
    fd1 = ld1 + fd0;
...
if(ao2 != null){
    ...
    boolean lb9 = false;
if(ao1 != null){
      ab1 = ao1.m2(ao2, ao3, ao4, fo0, fd0, fd1, ld1, ld7, ab2, ab3, ab4, fb0);
}
    fb1 = lb2 || lb3;
...
if(ao3 != null){
      ao2 = ao3.m4(ld1, ad1, ad2, ad3, ab3, ab4, fb0, fb1);
}
if(ao4 != null){
...
if(ao4 != null){
      ao3 = ao4.m4(fo0, fo1, ao1, ao2, ld1, ad1, ad2, ad3, lb0, ab1, ab2, ab3);
}
    ad4 = fd0 + fd1;
    ld1 = ad1 - ad2;
if(ao4 != null){
...
if(fo0 != null){
    ...
    boolean lb3 = true;
if(fo1 != null){
      fo1.m3(ld1, fd0, fd1, ld1, ab4, fb0, fb1, lb0);
}
    boolean lb4 = true;
if(fo0 != null){
...
if(fo1 != null){
      fo1.m2(fo0, fo1, fo0, fo1, fd0, fd1, ld1, fd0, lb3, lb4, ab1, ab2);
}
    ab3 = fd1 > ld1;
...
if(fo0 != null){
    ...
    fb1 = fb0 && fb1;
    fb0 = fb1 || fb0;
    Thought lo0 = Thought43.getInstance(fo1, fo0, fo1, fo0, ad3, ad4, fd0, fd1);
if(fo0 != null){
      fo1 = fo0.m4(fb1, fb0, fb1, fb0);
}
if(fo1 != null){
    ...
    ad2 *= -1;
if(fo1 != null){
      fo0 = fo1.m4(ad3, ad4, fd0, fd1, lb2, fb0, fb1, lb1);
}
    boolean lb3 = false;
if(fo1 != null){
      fo0 = fo1.m4(fo0, fo1, fo0, fo1);
    ...
    ad1 = ad2 - ad3;
if(fo0 != null){
          lb2 = fo0.m2(fo1, fo0, fo1, fo0, ad4, fd0, fd1, ad1, lb3, fb0, fb1, lb1);
}
if(fo0 != null){
...
if(fo1 != null){
        ...
        for(int i0=0; i0<10; i0++){
            Thought lo2 = Thought55.getInstance(fo0, fo1, fo0, fo1, fd1, ad1, ad2, ad3, fb1, lb0, lb1, ab1);
            boolean lb3 = false;
}}
Thought.STACK_COUNTER++;
return ab4;
...
if(ao1 != null){
      fo1 = ao1.m4(fd1, fd0, fd1, fd0, fb1, lb0, fb0, fb1);
}
    if (lb0) {
        fd1 *= -1;
        fb0 = fd0 > fd1;
if(ao2 != null){
        ...
        if (fb1) {
            fd0 *= -1;
if(ao1 != null){
              fd1 = ao1.m3(ao2, ao3, ao4, fo0, fd0, fd1, fd0, fd1, lb0, fb0, fb1, lb0);
}
            boolean lb1 = true;
            Thought lo2 = Thought57.getInstance(fo1, ao1, ao2, ao3, lb0, fb0, fb1, lb1);
if(ao4 != null){
...
if(ao3 != null){
      ao3.m2(ao4, fo0, fo1, ao1, fd0, fd1, ad1, ad2, fb1, ab1, ab2, ab3);
}
    boolean lb0 = false;
    Thought lo1 = Thought20.getInstance(ao2, ao3, ao4, fo0, ab3, ab4, fb0, fb1);
    lb0 = ab1 && ab2;
    ab3 = ad3 > ad4;
    Thought lo2 = Thought83.getInstance(fd0, fd1, ad1, ad2);
if(fo1 != null){
      fo1.m3(ao1, ao2, ao3, ao4, ad3, ad4, fd0, fd1);
}
    Thought lo3 = Thought76.getInstance(ab4, fb0, fb1, lb0);
    if (ab1) {
}
Thought.STACK_COUNTER++;
return ab2;
...
if(fo0 != null){
    ...
    for(int i0=0; i0<10; i0++){
        if (fb1) {
            ...
            lb0 = ld2 > fd0;
            Thought lo3 = Thought8.getInstance(fd1, ld2, fd0, fd1, lb1, ab1, ab2, ab3);
            ld2 *= -1;
if(fo1 != null){
...
try {
if (false) { throw new CountDownExc(-1); }
    Thought lo0 = Thought33.getInstance(fo0, fo1, fo0, fo1, ad2, ad3, ad4, fd0, fb1, fb0, fb1, fb0);
if(fo0 != null){
...
if(fo0 != null){
    ...
    Thought lo4 = Thought9.getInstance(fd0, fd1, ld1, ld3, fb1, fb0, fb1, fb0);
    ad1 *= -1;
if(fo0 != null){
      fo1 = fo0.m4(fo1, fo0, fo1, fo0);
}
    ad2 = ad3 - ad4;
if(fo1 != null){
      fd0 = fo1.m3(fo0, fo1, fo0, fo1, fd1, ld1, ld3, ad1, fb1, fb0, fb1, fb0);
}
    ad2 *= -1;
    fb1 = fb0 && fb1;
    fb0 = fb1 || fb0;
...
if(ao2 != null){
    ...
    fd0 = fd1 + fd0;
    fd1 *= -1;
    Thought lo2 = Thought63.getInstance(ao1, ao2, ao3, ao4, lb1, fb0, fb1, lb0);
    lb1 = fb0 || fb1;
    lb0 = fd0 < fd1;
    fd0 = fd1 - fd0;
...
if(ao2 != null){
    ...
    Thought lo1 = Thought68.getInstance(fb1, fb0, fb1, fb0);
    fd0 = fd1 + ad1;
if(ao1 != null){
      ad2 = ao1.m3();
}
...
if(fo0 != null){
    ...
    Thought lo2 = Thought73.getInstance(ao4, fo0, fo1, ao1, ad1, ad2, ad3, ad4, fb0, fb1, fb0, fb1);
    fb0 = fb1 && fb0;
    fd0 = fd1 + ad1;
...
if (false) { throw new CountDownExc(-1); }
    ...
    fd0 *= -1;
    lb1 = fd1 < fd0;
    Thought lo2 = Thought8.getInstance(ao2, ao3, ao4, fo0, ab1, ab2, ab3, ab4);
    fb0 = fb1 && lb0;
    lb1 = !ab1;
if(ao1 != null){
...
if(ao2 != null){
    ...
    if (ab2) {
        ...
        ab3 = ld3 > fd0;
        ab4 = fb0 && fb1;
        Thought lo4 = Thought44.getInstance(lb0, lb1, ab1, ab2);
if(ao1 != null){
          ao1.m3();
}
if(ao2 != null){
          ao2.m3(fd1, ld3, fd0, fd1, ab3, ab4, fb0, fb1);
}
if(ao4 != null){
...
if (false) { throw new CountDownExc(-1); }
    ...
    ab1 = ab2 || ab3;
if(ao1 != null){
      ad2 = ao1.m3(ao2, ao3, ao4, fo0, ad3, ad4, fd0, fd1, ab4, fb0, fb1, lb2);
}
if(fo1 != null){
...
if(fo1 != null){
    ...
    Thought lo2 = Thought92.getInstance(fo0, fo1, fo0, fo1, fb1, lb0, lb1, fb0);
    fb1 = lb0 || lb1;
    fb0 = fb1 || lb0;
    fd0 *= -1;
    fd1 = fd0 + fd1;
...
if (false) { throw new CountDownExc(-1); }
    ...
    Thought lo1 = Thought78.getInstance(fo0, fo1, fo0, fo1);
    ad2 = ad3 + ad4;
    fb0 = fb1 && fb0;
    fd0 = fd1 - ld0;
    double ld2 = 641.6520220461341;
if(fo0 != null){
      fo0.m1(fo1, fo0, fo1, fo0, ld2, ad1, ad2, ad3, fb1, fb0, fb1, fb0);
}
    fb1 = ad4 > fd0;
    fd1 = ld0 - ld2;
    fb0 = ad1 > ad2;
...
if(fo0 != null){
    ...
    Thought lo4 = Thought82.getInstance(fb1, lb3, fb0, fb1);
    ad3 = ad4 + fd0;
if(fo1 != null){
      fo1.m1();
}
if(fo1 != null){
      fo0 = fo1.m4(fd1, ld0, ld2, ad1, lb3, fb0, fb1, lb3);
}
if(fo0 != null){
    ...
    ad2 = ad3 - ad4;
if(fo1 != null){
      fb1 = fo1.m2(fo0, fo1, fo0, fo1, fd0, fd1, ld0, ld2, lb3, fb0, fb1, lb3);
}
    boolean lb5 = false;
if(fo0 != null){
      ad1 = fo0.m3(fo1, fo0, fo1, fo0, lb5, fb0, fb1, lb3);
}
    lb5 = ad2 > ad3;
...
if(fo0 != null){
    ...
    Thought lo1 = Thought83.getInstance(ab2, ab3, ab4, fb0);
...
if (false) { throw new CountDownExc(-1); }
    ...
    fb1 = ad4 > fd0;
        boolean lb0 = false;
if(ao2 != null){
      lb0 = ao2.m2(fd1, ad1, ad2, ad3);
}
    Thought lo1 = Thought39.getInstance(ao3, ao4, fo0, fo1, ad4, fd0, fd1, ad1);
    fb0 = ad2 > ad3;
if(ao1 != null){
...
if(ao3 != null){
    ...
    lb0 = !fb0;
if(ao4 != null){
      ao4.m1(ad4, fd0, fd1, ad1, fb1, lb0, fb0, fb1);
}
...
if(ao2 != null){
        ...
        boolean lb2 = false;
if(ao1 != null){
          ao1.m1(ao2, ao3, ao4, fo0, fd0, fd1, fd0, fd1, lb0, lb1, lb2, ab1);
}
if(fo1 != null){
...
if(ao4 != null){
              ao3 = ao4.m4(ld3, fd0, fd1, ld3, ab4, fb0, fb1, lb0);
}
            fd0 = fd1 - ld3;
            Thought lo4 = Thought72.getInstance(fo0, fo1, ao1, ao2);
if(ao3 != null){
              ao3.m2(ao4, fo0, fo1, ao1, fd0, fd1, ld3, fd0, lb1, lb2, ab1, ab2);
}
}}
Thought.STACK_COUNTER++;
return ao2;
...
if(fo0 != null){
      ao4 = fo0.m4(ad1, ad2, ad3, ad4, fb0, fb1, lb0, ab1);
}
...
if(fo0 != null){
      ad4 = fo0.m3(fo1, ao1, ao2, ao3, fd0, fd1, ld1, ld2, ab2, ab3, ab4, fb0);
}
    boolean lb3 = false;
if(fo0 != null){
...
if(fo0 != null){
    ...
    Thought lo4 = Thought8.getInstance(fo1, ao1, ao2, ao3, fd0, fd1, ld1, ld2);
    if (ab4) {
...
if(fo1 != null){
    ...
    fb1 = lb3 && fb0;
if(fo0 != null){
      ld0 = fo0.m3(fo1, fo0, fo1, fo0, ld1, fd0, fd1, ld0, fb1, lb3, fb0, fb1);
}
if(fo0 != null){
...
if(fo0 != null){
      fo0.m2(ld0, ld1, ld3, fd0);
}
    boolean lb4 = false;
if(fo0 != null){
      fo1 = fo0.m4(fo1, fo0, fo1, fo0, fd1, ld0, ld1, ld3);
}
if(fo1 != null){
      fd0 = fo1.m3(lb2, lb4, fb0, fb1);
}
    fd1 = ld0 + ld1;
if(fo0 != null){
      fo0.m3();
...
if(fo1 != null){
    ...
    ld1 *= -1;
    boolean lb2 = false;
    Thought lo3 = Thought96.getInstance(fo0, fo1, fo0, fo1, fd0, fd1, ld1, fd0, fb0, fb1, lb2, fb0);
if(fo1 != null){
      fo0 = fo1.m4(fo0, fo1, fo0, fo1, fb1, lb2, fb0, fb1);
}
    fd1 = ld1 + fd0;
    lb2 = fb0 && fb1;
    lb2 = fb0 || fb1;
    Thought lo4 = Thought18.getInstance(fd1, ld1, fd0, fd1);
    ld1 = fd0 - fd1;
    boolean lb5 = false;
if(fo0 != null){
