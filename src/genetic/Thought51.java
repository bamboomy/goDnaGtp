...
private double fd0 = 123.71138659891005;
private double fd1 = 441.9740012975057;
...
if(fo0 != null){
        ...
        boolean lb3 = false;
if(fo0 != null){
          fo1 = fo0.m4(fo1, fo0, fo1, fo0, fd1, ld1, fd0, fd1, lb3, lb0, fb0, fb1);
}
if(fo1 != null){
          fo1.m3(fo0, fo1, fo0, fo1, lb3, lb0, fb0, fb1);
}
        lb3 = lb0 && fb0;
if(fo1 != null){
...
if(fo1 != null){
        ...
        double ld1 = 844.3813587022148;
        Thought lo2 = Thought55.getInstance(fd0, fd1, ld1, ld0);
        if (fb0) {
            fd0 = fd1 + ld1;
            ld0 = fd0 - fd1;
            boolean lb3 = false;
            ...
            fb1 = lb3 || ab1;
            ab2 = fd1 < ld1;
            Thought lo4 = Thought73.getInstance(fo0, fo1, fo0, fo1, ld0, fd0, fd1, ld1);
            Thought lo5 = Thought60.getInstance(ab3, ab4, fb0, fb1);
}}
Thought.STACK_COUNTER++;
} catch (StackOverflowExc | NoClassDefFoundError e) { 
throw new CountDownExc(50);
...
if(fo1 != null){
    ...
    double ld0 = 851.6142714760184;
    Thought lo1 = Thought91.getInstance();
    Thought lo2 = Thought75.getInstance(ld0, ad1, ad2, ad3, fb0, fb1, ab1, ab2);
    if (ab3) {
        ab4 = fb0 && fb1;
        boolean lb3 = true;
        lb3 = !ab1;
...
if(fo0 != null){
          fb1 = fo0.m2(fo1, fo0, fo1, fo0, lb3, ab1, ab2, ab3);
}
if(fo0 != null){
...
if(fo0 != null){
        ...
        lb0 = fd0 > fd1;
        double ld1 = 999.7230229229613;
        boolean lb2 = false;
if(fo0 != null){
          ao4 = fo0.m4(fo1, ao1, ao2, ao3, ld1, fd0, fd1, ld1, lb2, fb0, fb1, lb0);
}
if(fo0 != null){
...
if(ao2 != null){
        ...
        Thought lo1 = Thought27.getInstance(ao1, ao2, ao3, ao4, ad2, ad3, ad4, fd0, fb1, fb0, fb1, fb0);
        fd1 *= -1;
        ad1 *= -1;
        boolean lb2 = false;
        Thought lo3 = Thought57.getInstance(fo0, fo1, ao1, ao2, fb0, fb1, lb2, fb0);
        ad2 = ad3 - ad4;
        } else {
        fd0 = fd1 + ad1;
if(ao3 != null){
...
if (false) { throw new CountDownExc(-1); }
    ...
    boolean lb2 = true;
if(ao1 != null){
          lb0 = ao1.m2(lb1, lb2, ab1, ab2);
}
    fd1 = fd0 + fd1;
    ab3 = !ab4;
    Thought lo3 = Thought76.getInstance();
    fb0 = fd0 < fd1;
...
if(ao2 != null){
    ...
    fb1 = fd0 > fd1;
    lb0 = !ab1;
    double ld1 = 49.9142244907952;
    ld1 = ad1 - ad2;
    Thought lo2 = Thought71.getInstance(ao3, ao4, fo0, fo1);
    ad3 *= -1;
if(ao1 != null){
      ab2 = ao1.m2(ao2, ao3, ao4, fo0, ad4, fd0, fd1, ld1, ab3, ab4, fb0, fb1);
}
if(ao1 != null){
...
if(fo0 != null){
    ...
    fd0 *= -1;
    lb0 = fb0 || fb1;
    Thought lo1 = Thought14.getInstance(fo1, fo0, fo1, fo0, fd1, fd0, fd1, fd0);
    if (lb0) {
if(fo1 != null){
...
if(fo1 != null){
    ...
    Thought lo0 = Thought85.getInstance(fd0, fd1, fd0, fd1);
if(fo1 != null){
      fo0 = fo1.m4(fo0, fo1, fo0, fo1, fd0, fd1, fd0, fd1);
}
    Output.points[0][1] += fd0;
    boolean lb1 = true;
    Thought lo2 = Thought75.getInstance(fb0, fb1, lb1, ab1);
    ab2 = !ab3;
    ab4 = fb0 && fb1;
if(fo0 != null){
      fo0.m3();
...
if(fo1 != null){
    ...
    Thought lo1 = Thought15.getInstance(fb1, fb0, fb1, fb0);
    boolean lb2 = true;
if(fo1 != null){
      fo0 = fo1.m4();
}
    Thought lo3 = Thought94.getInstance(ad3, ad4, fd0, fd1, fb0, fb1, lb2, fb0);
    Thought lo4 = Thought90.getInstance(fo0, fo1, fo0, fo1);
if(fo1 != null){
      fo0 = fo1.m4(fo0, fo1, fo0, fo1, ld0, ad1, ad2, ad3, fb1, lb2, fb0, fb1);
}
    lb2 = ad4 > fd0;
    boolean lb5 = false;
if(fo0 != null){
      fd1 = fo0.m3(fo1, fo0, fo1, fo0, lb5, fb0, fb1, lb2);
}
...
if(fo1 != null){
    ...
    Thought lo3 = Thought25.getInstance(ad2, ad3, ad4, fd0, fb0, fb1, lb1, lb2);
    boolean lb4 = true;
    double ld5 = 679.3417344180712;
...
if(ao1 != null){
    ...
    double ld0 = 67.08578982038095;
if(fo1 != null){
      fo1.m2(fb1, fb0, fb1, fb0);
}
    double ld1 = 250.26822750200472;
    boolean lb2 = false;
if(ao2 != null){
      ao1 = ao2.m4();
}
    ld1 = fd0 + fd1;
    double ld3 = 58.440966359660564;
...
if (false) { throw new CountDownExc(-1); }
    ...
    boolean lb0 = false;
if(ao1 != null){
      ad3 = ao1.m3(ad4, fd0, fd1, ad1, lb0, fb0, fb1, lb0);
}
if(ao2 != null){
    ...
    ad2 = ad3 + ad4;
    fb0 = fb1 && lb0;
        double ld1 = 212.25836241550658;
if(ao2 != null){
      ao1 = ao2.m4(ao3, ao4, fo0, fo1, ad4, fd0, fd1, ld1, fb0, fb1, lb0, fb0);
}
    boolean lb2 = true;
    for(int i0=0; i0<10; i0++){
        double ld3 = 110.93909707637347;
        ld1 = ad1 - ad2;
if(ao1 != null){
          fb0 = ao1.m2(ao2, ao3, ao4, fo0, fb1, lb0, lb2, fb0);
}
        double ld4 = 481.41703688330523;
        ad2 = ad3 - ad4;
        fd0 *= -1;
        fb1 = lb0 || lb2;
}
...
if (false) { throw new CountDownExc(-1); }
    fd1 = fd0 + fd1;
    Thought lo0 = Thought23.getInstance(fd0, fd1, fd0, fd1);
    fd0 *= -1;
    ab2 = ab3 || ab4;
if(ao3 != null){
...
if(fo1 != null){
    ...
    boolean lb6 = false;
if(fo0 != null){
      fd0 = fo0.m3(fo1, ao1, ao2, ao3, fd1, fd0, fd1, fd0, lb6, ab1, ab2, ab3);
}
        fd1 = fd0 - fd1;
    ab4 = fd0 < fd1;
if(ao4 != null){
      fb0 = ao4.m2(fo0, fo1, ao1, ao2, fb1, lb1, lb3, lb4);
}
    for(int i0=0; i0<10; i0++){
}
Thought.STACK_COUNTER++;
...
if (false) { throw new CountDownExc(-1); }
    ...
    fd0 = fd1 + ad1;
    ab1 = !ab2;
    Thought lo1 = Thought34.getInstance(ao1, ao2, ao3, ao4, ad2, ad3, ad4, fd0);
if(fo1 != null){
...
if(fo1 != null){
    ...
    lb0 = lb1 || lb2;
    if (fb0) {
        Thought lo3 = Thought59.getInstance(fb1, lb0, lb1, lb2);
}
Thought.STACK_COUNTER++;
return fd0;
} catch (StackOverflowExc | NoClassDefFoundError e) { throw new CountDownExc(50);
...
if(fo0 != null){
    ...
    double ld0 = 774.2296816262472;
    Thought lo1 = Thought46.getInstance(fo1, fo0, fo1, fo0);
if(fo0 != null){
...
if(fo1 != null){
        ...
        double ld2 = 703.2790216034603;
if(fo1 != null){
          fo0 = fo1.m4(ld2, ld0, fd0, fd1);
}
        fb1 = ld2 > ld0;
        Output.points[1][0] -= fd0;
        double ld3 = 311.4778070094582;
}
Thought.STACK_COUNTER++;
return ld0;
} catch (StackOverflowExc | NoClassDefFoundError e) { throw new CountDownExc(50);
...
if(fo1 != null){
    ...
    ad4 = fd0 - fd1;
if(fo0 != null){
      fo0.m3(ad1, ad2, ad3, ad4, fb1, lb0, lb1, lb2);
}
    fb0 = fb1 || lb0;
    boolean lb3 = true;
if(fo1 != null){
...
if(fo1 != null){
      fo1.m3(ad3, ad4, fd0, fd1, fb1, lb0, ab1, ab2);
}
    Thought lo1 = Thought23.getInstance(fo0, fo1, fo0, fo1);
    Output.points[1][3] -= ad1;
    Thought lo2 = Thought57.getInstance(fo0, fo1, fo0, fo1, ad2, ad3, ad4, fd0, ab3, ab4, fb0, fb1);
if(fo0 != null){
...
if(fo1 != null){
              fd0 = fo1.m3(fd1, ld0, fd0, fd1, fb1, lb2, lb1, fb0);
}
            boolean lb3 = false;
}}
Thought.STACK_COUNTER++;
...
if(ao1 != null){
    ...
    fb1 = fd1 < ad1;
    boolean lb0 = true;
    Thought lo1 = Thought15.getInstance(fo1, ao1, ao2, ao3, ad2, ad3, ad4, fd0, lb0, fb0, fb1, lb0);
if(ao4 != null){
      ao4.m2(fo0, fo1, ao1, ao2, fb0, fb1, lb0, fb0);
}
    fb1 = fd1 < ad1;
    double ld2 = 904.6209337388898;
    boolean lb3 = false;
if(ao3 != null){
      ad1 = ao3.m3(ad2, ad3, ad4, fd0);
}
if(ao4 != null){
      lb0 = ao4.m2(fo0, fo1, ao1, ao2, fd1, ld2, ad1, ad2);
}
if(ao4 != null){
...
if(fo1 != null){
    ...
    for(int i0=0; i0<10; i0++){
        lb3 = fb0 && fb1;
        boolean lb4 = true;
        Thought lo5 = Thought46.getInstance(ad4, fd0, fd1, ld2, lb4, lb0, lb3, fb0);
if(ao2 != null){
          ao1 = ao2.m4(ao3, ao4, fo0, fo1);
}
if(ao1 != null){
          ao1.m2(ao2, ao3, ao4, fo0, ad1, ad2, ad3, ad4, fb1, lb4, lb0, lb3);
}
}
Thought.STACK_COUNTER++;
return fd0;
...
if(fo1 != null){
      fo0 = fo1.m4(fd0, fd1, ld1, fd0, lb0, lb2, ab1, ab2);
}
    for(int i0=0; i0<10; i0++){
...
if(ao1 != null){
          fo1 = ao1.m4(ao2, ao3, ao4, fo0, ld1, fd0, fd1, ld1, ab4, fb0, fb1, lb0);
}
        fd0 = fd1 - ld1;
if(ao1 != null){
...
if(ao2 != null){
    ...
    ab1 = fd0 > fd1;
    Thought lo0 = Thought12.getInstance(ab2, ab3, ab4, fb0);
    boolean lb1 = false;
if(ao2 != null){
      ao1 = ao2.m4();
}
    ...
    if (lb1) {
        ab1 = ab2 && ab3;
if(ao4 != null){
          ao3 = ao4.m4(ad2, ad3, ad4, fd0, ab4, fb0, fb1, lb1);
}
        boolean lb2 = false;
if(fo1 != null){
          fo0 = fo1.m4(ao1, ao2, ao3, ao4);
...
if(fo1 != null){
    ...
    Thought lo1 = Thought92.getInstance(fd0, fd1, ld0, fd0);
    Thought lo2 = Thought82.getInstance(fo0, fo1, fo0, fo1, fd1, ld0, fd0, fd1);
if(fo0 != null){
      ld0 = fo0.m3(fb0, fb1, fb0, fb1);
}
    Thought lo3 = Thought68.getInstance();
...
if(fo0 != null){
    ...
    double ld2 = 929.5216075809197;
    double ld3 = 31.79543936810342;
    lb0 = lb1 && ab1;
    ld2 *= -1;
    ld3 *= -1;
    Thought lo4 = Thought10.getInstance(fo1, fo0, fo1, fo0, ab2, ab3, ab4, fb0);
    if (fb1) {
        lb0 = fd0 > fd1;
}
Thought.STACK_COUNTER++;
...
if(fo0 != null){
    ...
    boolean lb1 = false;
    Thought lo2 = Thought13.getInstance(fb0, fb1, lb0, lb1);
if(fo0 != null){
      fo1 = fo0.m4();
}
if(fo0 != null){
...
if(fo1 != null){
      fo1.m3(fo0, fo1, fo0, fo1, fd1, ad1, ad2, ad3, fb0, fb1, lb0, lb1);
}
if(fo1 != null){
...
if (false) { throw new CountDownExc(-1); }
    for(int i0=0; i0<10; i0++){
        ...
        ab1 = ab2 && ab3;
if(fo0 != null){
          fo0.m1(fd0, fd1, ad1, ad2, ab4, fb0, fb1, lb0);
}
        ab1 = ab2 || ab3;
if(fo1 != null){
          fo1.m3(fo0, fo1, fo0, fo1);
}
        Thought lo1 = Thought43.getInstance(fo0, fo1, fo0, fo1, ad3, ad4, fd0, fd1, ab4, fb0, fb1, lb0);
        Output.points[2][1] += ad1;
        boolean lb2 = true;
        Thought lo3 = Thought99.getInstance(fo0, fo1, fo0, fo1, lb2, ab1, ab2, ab3);
        boolean lb4 = false;
}
Thought.STACK_COUNTER++;
return fo0;
...
if(fo0 != null){
      fd1 = fo0.m3(ld1, fd0, fd1, ld1, fb1, lb0, fb0, fb1);
}
if(fo1 != null){
      fd0 = fo1.m3(ao1, ao2, ao3, ao4);
}
if(fo0 != null){
      fd1 = fo0.m3(fo1, ao1, ao2, ao3, ld1, fd0, fd1, ld1, lb0, fb0, fb1, lb0);
}
...
if(ao1 != null){
    ...
    Thought lo1 = Thought45.getInstance(fo1, ao1, ao2, ao3, ad4, fd0, fd1, ad1, fb1, lb0, fb0, fb1);
if(ao4 != null){
      ad2 = ao4.m3(fo0, fo1, ao1, ao2, lb0, fb0, fb1, lb0);
}
    fb0 = ad3 > ad4;
if(ao4 != null){
...
if(fo1 != null){
    ...
    Thought lo4 = Thought50.getInstance(ad2, ad3, ad4, fd0, lb2, lb3, fb0, fb1);
    Output.points[2][3] += fd1;
    double ld5 = 583.9998647190091;
    ld5 = ad1 - ad2;
if(ao1 != null){
...
if(ao3 != null){
    ...
    ab1 = ad2 < ad3;
    double ld0 = 112.9246721044903;
if(ao4 != null){
      ad3 = ao4.m3(ad4, fd0, fd1, ld0, ab2, ab3, ab4, fb0);
}
if(fo0 != null){
...
if(fo0 != null){
    ...
    Thought lo2 = Thought42.getInstance(fo1, fo0, fo1, fo0, fd0, fd1, fd0, fd1);
    lb1 = fd0 > fd1;
...
if(fo1 != null){
    ...
    fb1 = fd1 > fd0;
    fd1 = fd0 + fd1;
    Thought lo3 = Thought18.getInstance();
    fd0 = fd1 + fd0;
    fd1 = fd0 - fd1;
...
if (false) { throw new CountDownExc(-1); }
    ...
    boolean lb1 = true;
if(fo0 != null){
      lb0 = fo0.m2(fd0, fd1, fd0, fd1, lb1, fb0, fb1, lb0);
}
if(fo0 != null){
      fo1 = fo0.m4(fo1, fo0, fo1, fo0);
}
...
if(fo1 != null){
    ...
    Thought lo2 = Thought37.getInstance(fd0, fd1, fd0, fd1);
if(fo1 != null){
      fo0 = fo1.m4(fo0, fo1, fo0, fo1, fd0, fd1, fd0, fd1);
}
if(fo1 != null){
