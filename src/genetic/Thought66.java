...
private double fd0 = 308.5646485446605;
private double fd1 = 928.8201886408606;
...
if(fo0 != null){
    ...
    Thought lo6 = Thought85.getInstance(fd0, fd1, fd0, fd1, fb1, lb0, lb1, lb3);
    fd0 = fd1 + fd0;
    Thought lo7 = Thought65.getInstance(fo1, fo0, fo1, fo0);
if(fo0 != null){
      fo1 = fo0.m4(fo1, fo0, fo1, fo0, fd1, fd0, fd1, fd0, lb4, ab1, ab2, ab3);
}
if(fo0 != null){
...
if (false) { throw new CountDownExc(-1); }
    for(int i0=0; i0<10; i0++){
        double ld0 = 774.8719226021008;
        double ld1 = 396.38331166970937;
        fb1 = fb0 && fb1;
if(fo0 != null){
...
if (false) { throw new CountDownExc(-1); }
    boolean lb0 = false;
    fd0 *= -1;
    Thought lo1 = Thought19.getInstance(ao1, ao2, ao3, ao4, fd1, fd0, fd1, fd0);
if(fo0 != null){
...
if(fo1 != null){
    ...
    fd1 = fd0 - fd1;
    fd0 *= -1;
    Thought lo3 = Thought59.getInstance(fd1, fd0, fd1, fd0, lb0, lb2, fb0, fb1);
if(ao2 != null){
    ...
    fd0 *= -1;
    fd1 *= -1;
    Thought lo4 = Thought68.getInstance(ao1, ao2, ao3, ao4, fd0, fd1, fd0, fd1, lb2, fb0, fb1, lb0);
    fd0 *= -1;
...
if(ao1 != null){
    ...
    lb1 = fb0 && fb1;
if(ao2 != null){
      lb1 = ao2.m2(ad2, ad3, ad4, fd0, fb0, fb1, lb1, fb0);
}
    boolean lb2 = true;
    fb0 = fb1 && lb1;
    Thought lo3 = Thought84.getInstance(ao3, ao4, fo0, fo1);
    double ld4 = 113.38074365730655;
    fd0 = fd1 + ld4;
    lb2 = ad1 < ad2;
    for(int i0=0; i0<10; i0++){
        ad3 = ad4 + fd0;
        fb0 = fb1 || lb1;
if(ao1 != null){
          ao1.m3(ao2, ao3, ao4, fo0, fd1, ld4, ad1, ad2, lb2, fb0, fb1, lb1);
}
        lb2 = ad3 > ad4;
if(ao1 != null){
...
if (false) { throw new CountDownExc(-1); }
    ...
    fd0 *= -1;
    fd1 *= -1;
    double ld0 = 689.1686160819667;
    ld0 *= -1;
if(ao2 != null){
          ao2.m3(fd0, fd1, ld0, fd0);
}
if(ao3 != null){
      ab3 = ao3.m2(ao4, fo0, fo1, ao1, fd1, ld0, fd0, fd1);
}
    ab4 = fb0 || fb1;
    ld0 = fd0 + fd1;
...
if(fo1 != null){
    ...
    fd0 = fd1 - ld0;
    Thought lo1 = Thought90.getInstance(fo0, fo1, ao1, ao2, fd0, fd1, ld0, fd0, ab1, ab2, ab3, ab4);
if(ao3 != null){
...
if(ao4 != null){
    ...
    fb0 = fb1 || ab1;
    Thought lo0 = Thought76.getInstance(ad3, ad4, fd0, fd1, ab2, ab3, ab4, fb0);
if(fo0 != null){
    ...
    boolean lb1 = true;
    fb0 = ad2 > ad3;
    Thought lo2 = Thought15.getInstance(ao4, fo0, fo1, ao1, ad4, fd0, fd1, ad1, fb1, lb1, ab1, ab2);
    ab3 = ad2 > ad3;
if(ao2 != null){
      ab4 = ao2.m2(ao3, ao4, fo0, fo1, fb0, fb1, lb1, ab1);
}
    ad4 = fd0 - fd1;
...
if(fo0 != null){
    ...
    for(int i1=0; i1<10; i1++){
        ...
        fd0 = fd1 + fd0;
        fd1 = fd0 - fd1;
        Thought lo4 = Thought65.getInstance();
        fd0 = fd1 + fd0;
}
Thought.STACK_COUNTER++;
return fb0;
...
if(fo1 != null){
    ...
    boolean lb0 = false;
    double ld1 = 700.061602038729;
    ad4 = fd0 - fd1;
    ld1 = ad1 - ad2;
    lb0 = fb0 && fb1;
    lb0 = fb0 || fb1;
    Thought lo2 = Thought83.getInstance(fo0, fo1, fo0, fo1, lb0, fb0, fb1, lb0);
    ad3 *= -1;
if(fo1 != null){
...
if (false) { throw new CountDownExc(-1); }
            for(int i0=0; i0<10; i0++){
        double ld0 = 155.14426037833348;
        ld0 = fd0 + fd1;
        ld0 *= -1;
        fb1 = fb0 && fb1;
if(ao1 != null){
          ao1.m1(fd0, fd1, ld0, fd0);
}
        double ld1 = 57.424518201241824;
if(ao3 != null){
        ...
        ld0 = ld1 - fd0;
        boolean lb2 = false;
        Thought lo3 = Thought88.getInstance(lb2, fb0, fb1, lb2);
if(ao2 != null){
          ao2.m1();
}
        ...
        fb0 = ld0 < ld1;
if(ao3 != null){
          fd0 = ao3.m3(fd1, ld0, ld1, fd0, fb1, lb2, fb0, fb1);
}
        boolean lb4 = false;
...
if (false) { throw new CountDownExc(-1); }
    ab1 = ab2 && ab3;
    Thought lo0 = Thought75.getInstance(fd1, fd0, fd1, fd0, ab4, fb0, fb1, ab1);
    fd1 *= -1;
if(ao2 != null){
      ao1 = ao2.m4(ao3, ao4, fo0, fo1);
}
    double ld1 = 601.2757129561134;
    ab2 = !ab3;
    ab4 = ld1 < fd0;
    Thought lo2 = Thought18.getInstance(ao1, ao2, ao3, ao4, fd1, ld1, fd0, fd1, fb0, fb1, ab1, ab2);
if(fo0 != null){
      ld1 = fo0.m3(fo1, ao1, ao2, ao3, ab3, ab4, fb0, fb1);
}
    fd0 *= -1;
    Output.points[6][1] += fd1;
if(ao4 != null){
      ab1 = ao4.m2(ld1, fd0, fd1, ld1);
}
    fd0 = fd1 + ld1;
    double ld3 = 144.77763167610482;
...
if(fo0 != null){
    ...
    Thought lo1 = Thought83.getInstance(fo1, ao1, ao2, ao3);
    ad3 *= -1;
    ab4 = !fb0;
if(fo0 != null){
      ao4 = fo0.m4(fo1, ao1, ao2, ao3, ad4, fd0, fd1, ad1, fb1, lb0, ab1, ab2);
}
    ab3 = ad2 > ad3;
    Output.points[6][4] -= ad4;
    double ld2 = 256.3319667438801;
if(fo0 != null){
      ao4 = fo0.m4(fo1, ao1, ao2, ao3, ab4, fb0, fb1, lb0);
}
    Thought lo3 = Thought20.getInstance(ad4, fd0, fd1, ld2);
    ab1 = ab2 || ab3;
    ad1 = ad2 - ad3;
    ab4 = ad4 > fd0;
    Thought lo4 = Thought3.getInstance(ao4, fo0, fo1, ao1, fd1, ld2, ad1, ad2);
if(ao2 != null){
    ...
    boolean lb6 = false;
if(ao3 != null){
      ad4 = ao3.m3(fd0, fd1, ld2, ad1, ab1, ab2, ab3, ab4);
}
    ad2 *= -1;
...
if(fo1 != null){
          fo1.m1(fo0, fo1, fo0, fo1, fd0, fd1, ld1, fd0, fb0, fb1, lb2, lb0);
}
        double ld3 = 70.17005919810201;
        boolean lb4 = true;
        fd0 *= -1;
if(fo0 != null){
          fo0.m3(fo1, fo0, fo1, fo0, lb0, fb0, fb1, lb2);
}
}
Thought.STACK_COUNTER++;
return ld1;
...
if(fo0 != null){
    ...
    fb1 = ab1 || ab2;
    double ld1 = 499.9386448296963;
    double ld2 = 315.12199380107063;
...
if(fo0 != null){
    ...
    fd1 *= -1;
if(fo1 != null){
      fo1.m3(fo0, fo1, fo0, fo1, ad1, ad2, ad3, ad4, fb0, fb1, lb0, fb0);
}
    double ld2 = 531.7797340795988;
    fb1 = lb0 && fb0;
    boolean lb3 = true;
    ad4 = fd0 + fd1;
    boolean lb4 = true;
    ...
    ld2 = ad1 + ad2;
if(fo1 != null){
      fo0 = fo1.m4(fo0, fo1, fo0, fo1, lb0, lb3, lb4, fb0);
}
    for(int i0=0; i0<10; i0++){
        ad3 *= -1;
        fb1 = ad4 < fd0;
...
if(fo0 != null){
    ...
    fb1 = ad2 > ad3;
    double ld0 = 51.98124200392303;
    ab1 = ad3 > ad4;
    ab2 = !ab3;
    ab4 = fd0 < fd1;
    ld0 = ad1 - ad2;
    double ld1 = 947.0222703914671;
if(fo1 != null){
      ad2 = fo1.m3();
}
...
if(ao2 != null){
    ...
    if (fb0) {
        fb1 = fb0 || fb1;
        double ld1 = 423.19006786320364;
if(ao2 != null){
          ao1 = ao2.m4(ao3, ao4, fo0, fo1, ld0, fd0, fd1, ld1, fb0, fb1, fb0, fb1);
}
if(ao2 != null){
...
if(ao2 != null){
    ...
    ad3 = ad4 - fd0;
if(ao3 != null){
      ao3.m3(fd1, ad1, ad2, ad3, fb0, fb1, fb0, fb1);
}
    ad4 = fd0 - fd1;
    ad1 = ad2 - ad3;
    fb0 = ad4 < fd0;
...
if(ao4 != null){
    ...
    Thought lo0 = Thought65.getInstance(ao3, ao4, fo0, fo1, fd1, ad1, ad2, ad3, fb0, fb1, fb0, fb1);
    ad4 *= -1;
    double ld1 = 198.6085530172528;
if(ao1 != null){
      ad4 = ao1.m3(ao2, ao3, ao4, fo0, fb0, fb1, fb0, fb1);
}
if(fo1 != null){
      fo1.m3(fd0, fd1, ld1, ad1);
}
...
if(ao3 != null){
    ...
    double ld1 = 543.3632068227688;
    ad1 *= -1;
    double ld2 = 422.093959442017;
    boolean lb3 = true;
    Thought lo4 = Thought36.getInstance();
    ab3 = ab4 && fb0;
    Thought lo5 = Thought47.getInstance(ad1, ad2, ad3, ad4, fb1, lb0, lb3, ab1);
    Thought lo6 = Thought73.getInstance(ao4, fo0, fo1, ao1);
    fd0 *= -1;
    fd1 = ld1 - ld2;
if(ao2 != null){
...
if(fo1 != null){
    ...
    fd1 = fd0 - fd1;
    Thought lo0 = Thought2.getInstance(fo0, fo1, fo0, fo1, fd0, fd1, fd0, fd1);
    fb0 = !fb1;
    fd0 = fd1 - fd0;
...
if(fo0 != null){
    ...
    ab1 = fd0 > fd1;
    fd0 = fd1 + fd0;
    Thought lo0 = Thought44.getInstance(fo1, fo0, fo1, fo0);
    ab2 = fd1 < fd0;
    ab3 = ab4 || fb0;
    fd1 *= -1;
...
if(fo1 != null){
    ...
    Thought lo2 = Thought5.getInstance(fo0, fo1, fo0, fo1, fd1, fd0, fd1, fd0);
    lb1 = fd1 > fd0;
    ab1 = fd1 < fd0;
if(fo1 != null){
...
if(fo1 != null){
    ...
    fb1 = fd1 < fd0;
if(fo0 != null){
      fd1 = fo0.m3(fd0, fd1, fd0, fd1, lb1, ab1, ab2, ab3);
}
if(fo0 != null){
      fo1 = fo0.m4(fo1, fo0, fo1, fo0);
}
    fd0 = fd1 - fd0;
if(fo1 != null){
      fo1.m1(fo0, fo1, fo0, fo1, fd1, fd0, fd1, fd0, ab4, fb0, fb1, lb1);
}
    fd1 *= -1;
    ab1 = ab2 || ab3;
    ab4 = fb0 && fb1;
...
if(fo1 != null){
    ...
    Thought lo0 = Thought15.getInstance(fo0, fo1, fo0, fo1, ad1, ad2, ad3, ad4);
    for(int i0=0; i0<10; i0++){
        boolean lb1 = false;
        lb1 = fd0 < fd1;
        fb0 = fb1 || lb1;
        boolean lb2 = true;
        Thought lo3 = Thought97.getInstance(lb2, fb0, fb1, lb1);
        double ld4 = 542.1556499137805;
        lb2 = ld4 > ad1;
        Thought lo5 = Thought29.getInstance();
if(fo0 != null){
          ad2 = fo0.m3(ad3, ad4, fd0, fd1, fb0, fb1, lb1, lb2);
}
        fb0 = fb1 || lb1;
        lb2 = ld4 < ad1;
        double ld6 = 375.73127440042066;
if(fo0 != null){
          fo1 = fo0.m4(fo1, fo0, fo1, fo0);
}
if(fo1 != null){
          fb0 = fo1.m2(fo0, fo1, fo0, fo1, ad1, ad2, ad3, ad4, fb1, lb1, lb2, fb0);
}
        fb1 = fd0 > fd1;
        ld4 = ld6 + ad1;
if(fo0 != null){
          ad2 = fo0.m3(fo1, fo0, fo1, fo0, lb1, lb2, fb0, fb1);
}
        lb1 = lb2 || fb0;
if(fo0 != null){
        ...
        fb1 = lb1 && lb2;
if(fo1 != null){
          fo1.m1(fo0, fo1, fo0, fo1, ld4, ld6, ad1, ad2);
}
...
if(fo0 != null){
    ...
    double ld0 = 645.3752735559459;
if(fo1 != null){
      fd0 = fo1.m3(fo0, fo1, fo0, fo1);
}
if(fo1 != null){
      fo0 = fo1.m4(fo0, fo1, fo0, fo1, fd1, ld0, ad1, ad2, ab1, ab2, ab3, ab4);
}
...
if(fo1 != null){
    ...
    ab1 = ad4 > fd0;
    ab2 = ab3 || ab4;
    double ld1 = 78.58644604914578;
if(fo0 != null){
      fd0 = fo0.m3(fo1, fo0, fo1, fo0, fd1, ld0, ld1, ad1);
}
    Thought lo2 = Thought86.getInstance(fb0, fb1, ab1, ab2);
if(fo0 != null){
      fo1 = fo0.m4();
}
    ad2 = ad3 - ad4;
...
if(ao3 != null){
    ...
    ad2 = ad3 + ad4;
    double ld0 = 304.7967977834312;
    double ld1 = 336.9725729947978;
if(fo0 != null){
      ao4 = fo0.m4(fo1, ao1, ao2, ao3, ad3, ad4, fd0, fd1);
}
    Thought lo2 = Thought62.getInstance(fb0, fb1, fb0, fb1);
...
if(ao2 != null){
    ...
    boolean lb1 = false;
if(ao3 != null){
      ad4 = ao3.m3(fd0, fd1, ad1, ad2, ab2, ab3, ab4, fb0);
}
    boolean lb2 = false;
if(fo0 != null){
...
if(fo0 != null){
      ao4 = fo0.m4(fo1, ao1, ao2, ao3, fd0, fd1, ad1, ad2, lb2, lb3, ab1, ab2);
}
...
if(fo0 != null){
    ...
    double ld2 = 262.11207611685535;
    boolean lb3 = true;
if(fo1 != null){
      lb3 = fo1.m2(fb0, fb1, lb1, lb3);
}
    fd0 = fd1 - ld0;
...
if (false) { throw new CountDownExc(-1); }
    ...
    lb1 = !lb2;
if(fo0 != null){
      fo0.m3(fd1, ld0, fd0, fd1, fb0, fb1, lb1, lb2);
}
    ld0 *= -1;
    fb0 = fb1 && lb1;
if(fo0 != null){
    ...
    Thought lo3 = Thought87.getInstance(fo1, fo0, fo1, fo0, fd0, fd1, ld0, fd0, lb2, fb0, fb1, lb1);
...
if(fo1 != null){
    ...
    double ld1 = 257.8748527038059;
    ld1 = fd0 + fd1;
if(fo0 != null){
      ld1 = fo0.m3(fb0, fb1, fb0, fb1);
}
